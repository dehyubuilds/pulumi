...
- DB Backend: Postgres RDS
- FrontEnd: Twilly in Fargate
"""
...
service_name = config.get('service_name') or 'kk'
db_name = config.get('db_name') or 'Twilly'
db_user = config.get('db_user') or 'kk_api'
